...
<!--      </style>-->
      <div style="width: 300px;">
        ...
        <br/>
        <img class="center" src="https://upload.wikimedia.org/wikipedia/commons/e/e0/Vaadin-logo.svg" height="80"/>
        <br/>
        <br/>
        <div>For authentication and authorization, this App uses <a href="https://www.okta.com/">okta</a>.</div>
        <br/>
        <img class="center" src="https://upload.wikimedia.org/wikipedia/commons/5/5c/Okta_logo.svg" height="60"/>
        <br/><br/>
